...
+ (NSData *)encryptData:(NSData *)data withKeyRef:(SecKeyRef) keyRef{
	...
	for(int idx=0; idx<srclen; idx+=src_block_size){        //分段加密
...
{
    NSData *data = [RSA encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] withKeyRef:pubSecKeyRef];
    NSString *ret = base64_encode_data(data);
    return ret;
}
...
{
    return [RSA encryptData:data withKeyRef:pubSecKeyRef];
}
